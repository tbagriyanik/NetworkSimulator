...
const example = (isTr: boolean): ExampleProject => {
  ...
  return {
    ...
    title: isTr ? 'Native VLAN YapÄ±landÄ±rmasÄ±' : 'Native VLAN Configuration',
    description: isTr
      ? 'Ä°ki switch arasÄ± native VLAN 99 trunk baÄŸlantÄ±sÄ± yapÄ±landÄ±rÄ±lÄ±r.'
