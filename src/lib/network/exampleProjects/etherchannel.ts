...
const example = (isTr: boolean): ExampleProject => {
  ...
  return {
    ...
    description: isTr
      ? 'LACP ile birden fazla link tek bir mantÄ±ksal baÄŸlantÄ±da birleÅŸtirilir.'
