...
const example = (isTr: boolean): ExampleProject => {
  ...
  return {
    ...
    description: isTr
      ? 'Router DHCP havuzu Ã¼zerinden iki PCye otomatik IP daÄŸÄ±tÄ±mÄ±.'
