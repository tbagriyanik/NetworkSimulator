...
const example = (isTr: boolean): ExampleProject => {
  ...
  const switch0State = createInitialState('00:1A:2B:3C:A4:80', 'NS-L2-24TT-L');
  ...
  const mlSwitch1State = createInitialState('00:1A:2B:3C:A4:00', 'NS-L3-24PS');
  mlSwitch1State.hostname = 'MultilayerSwitch1';
  mlSwitch1State.switchModel = 'NS-L3-24PS';
  ...
  const mlSwitch2State = createInitialState('00:1A:2B:3C:A4:40', 'NS-L3-24PS');
  mlSwitch2State.hostname = 'MultilayerSwitch2';
  mlSwitch2State.switchModel = 'NS-L3-24PS';
  ...
  const switch1State = createInitialState('00:1A:2B:3C:A4:C0', 'NS-L2-24TT-L');
