...
const example = (isTr: boolean): ExampleProject => {
  ...
  return {
    ...
    description: isTr
      ? 'Router iki fiziksel interface ile VLANlara baÄŸlanÄ±r, trunk kullanÄ±lmaz.'
