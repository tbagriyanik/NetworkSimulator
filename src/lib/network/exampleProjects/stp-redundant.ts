...
const example = (isTr: boolean): ExampleProject => {
  ...
  return {
    ...
    description: isTr
      ? 'Rapid-PVST redundant linklerde loop Ã¶nlemek iÃ§in STP kullanÄ±r.'
