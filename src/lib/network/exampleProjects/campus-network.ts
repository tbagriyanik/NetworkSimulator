...
const example = (isTr: boolean): ExampleProject => {
  ...
  return {
    ...
    description: isTr
      ? 'Core router iki access switch arasÄ± routing saÄŸlar.'
