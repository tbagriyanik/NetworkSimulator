...
const example = (isTr: boolean): ExampleProject => {
  ...
  const mlSwitch1State = createInitialState('00:1A:2B:3C:4D:80', 'NS-L3-24PS');
  ...
  const mlSwitch2State = createInitialState('00:1A:2B:3C:4D:81', 'NS-L3-24PS');
  ...
  const switch0State = createInitialState('00:1A:2B:3C:4D:82', 'NS-L2-24TT-L');
  ...
  const switch1State = createInitialState('00:1A:2B:3C:4D:83', 'NS-L2-24TT-L');
