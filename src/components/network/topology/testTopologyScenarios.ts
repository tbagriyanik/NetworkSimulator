...
export const TEST_TOPOLOGY_SCENARIOS: TestTopologyScenario[] = [
  // 1. STP Triangle & Root Election
  {
    ...
    descTr: '3 anahtarlı üçgen döngü topolojisi. SW2 (Bridge Priority: 4096) root seçilir, döngü engelleyici port bloke edilir.',
    descEn: '3-switch triangle loop topology. SW2 (Bridge Priority: 4096) is elected root, blocking ports prevent broadcast storms.',
  ...
  // 2. MSTP Multi-Instance Spanning Tree
  {
    ...
    descTr: 'MST bölgesi, MSTI 1 (VLAN 10-20) ve MSTI 2 (VLAN 30-40) için farklı kök köprülerle yük dengeleme.',
    descEn: 'MST Region with Instance 1 and Instance 2 load balancing. Separate root bridges per VLAN instance.',
  ...
  // 3. EtherChannel LACP & Member Failure Recovery
  {
    ...
    descTr: 'SW1 ve SW2 arasında 2x 1Gbps LACP Port-Channel1 bağı. Link kesintisinde kesintisiz iletim.',
    descEn: 'Dual-link LACP Port-Channel1 between switches. Validates bandwidth aggregation and sub-second failover.',
  ...
  // 4. Multi-Area OSPF & Virtual Link
  {
    ...
    descTr: 'Area 0 (Backbone), Area 1 ve Area 2 (Transit) OSPF hiyerarşik yönlendirme mimarisi.',
    descEn: 'Hierarchical OSPF topology with Area 0, Area 1, and Area 2 transit virtual link.',
  ...
  // 5. BGP Advanced & AS-Path Loop Prevention
  {
    ...
    descTr: 'eBGP komşulukları, AS 65001 & AS 65002 prefix reklamı ve AS-Path döngü koruma testi.',
    descEn: 'eBGP peering, AS 65001 & AS 65002 prefix advertisements, and AS-Path loop prevention test.',
  ...
  // 6. VXLAN EVPN Fabric E2E Test
  {
    ...
    descTr: 'Spine-Leaf EVPN kumaşı. NVE1 (VNI 10010, VLAN 10), BGP EVPN Type-2 MAC rotaları ve UDP 4789 kapsülleme.',
    descEn: 'Spine-Leaf EVPN fabric. NVE1 (VNI 10010, VLAN 10), BGP EVPN Type-2 MAC routes, and UDP 4789 encapsulation.',
  ...
  // 7. VRF-Lite Multi-Tenant Network Isolation
  {
    ...
    descTr: 'VRF "Red" ve VRF "Blue" yönlendirme izolasyonu. Çakışan 10.0.0.0/24 IP adreslerinin bağımsız yönlendirilmesi.',
    descEn: 'VRF-Lite isolation. Overlapping subnets (10.0.0.0/24) routed independently across Customer Red & Blue.',
  ...
  // 8. FHRP / HSRP / VRRP Redundancy Gateway Test
  {
    ...
    descTr: 'Sanal Ağ Geçidi (VIP: 192.168.1.254) ve Aktif/Beklemede (Active/Standby) yönlendirici geçiş testi.',
    descEn: 'Virtual Gateway (VIP: 192.168.1.254) failover and Active/Standby router test.',
  ...
  // 9. NAT / PAT Dynamic Port Address Translation
  {
    ...
    descTr: 'Inside Local IP adreslerinin tek bir Public IP üzerine port eşlemesiyle taşınması.',
    descEn: 'Inside Local to Outside Global dynamic PAT translation and timeout lifecycle.',
  ...
  // 10. 802.1X & RADIUS Port Authentication E2E
  {
    ...
    descTr: 'EAPOL el sıkışması ve RADIUS sunucu doğrulaması. Doğrulama öncesi port bloklanır, yetkilendirme sonrası açılır.',
    descEn: '802.1X EAPOL handshake & RADIUS server validation. Traffic blocked until authentication succeeds.',
  ...
  // 11. Stateful Firewall & DMZ Security Zone
  {
    ...
    descTr: 'Inside -> Outside TCP oturum izleme, DMZ Web sunucusu ve otomatik geri dönüş izni.',
    descEn: 'Stateful TCP inspection and DMZ web security policy validation.',
  ...
  // 12. IPsec VPN Site-to-Site Tunnel E2E
  {
    ...
    descTr: 'Şube (Branch) ile Merkez (HQ) arasında IKE Phase 1 / Phase 2 ve ESP şifreli IPsec tüneli.',
    descEn: 'Branch to HQ Site-to-Site IPsec VPN pipeline. Validates IKE Phase 1/2 and ESP tunnel encryption.',
  ...
  // 13. QoS Class-Map & Policy-Map E2E
  {
    ...
    descTr: 'Voice/Video/Bulk trafiği için Class-Map ve Policy-Map yapılandırması. DSCP etiketleme ve kuyruk kuyruklama testi.',
    descEn: 'Class-Map and Policy-Map pipeline. Tests DSCP EF/AF tagging, bandwidth reservation, and queuing priority.',
  ...
  // 14. IPv6 SLAAC, DHCPv6 & NDP Resolution
  {
    ...
    descTr: 'Router Advertisement (RA), SLAAC otomatik adresleme ve NDP komşu önbelleği testi.',
    descEn: 'IPv6 SLAAC auto-addressing, Router Solicitations, and NDP cache lifecycle.',
  ...
  // 15. Wireless WLC & CAPWAP Lightweight AP Test
  {
    ...
    descTr: 'Merkezi WLC Controller ve CAPWAP tüneli üzerinden bağlanan AP ve kablosuz istemciler.',
    descEn: 'Centralized WLC Controller and CAPWAP tunnel management for Access Points.',
  ...
  // 16. Packet Trace & Forwarding Pipeline
  {
    ...
    descTr: 'PC1 -> SW1 -> R1 -> R2 -> PC2 tam teşhis akışı. ARP çözünürlüğü, MAC tablosu ve ICMP iletimi.',
    descEn: 'PC1 -> SW1 -> R1 -> R2 -> PC2 diagnostic pipeline. Tests ARP resolution, MAC learning, and hop-by-hop ICMP.',
