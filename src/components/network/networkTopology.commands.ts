  ...
  return [
    ...
    },
    {
      ...
      cmds: [
        ...
        ['do <command>', isTR ? 'Privileged komut çalıştır' : 'Execute privileged cmd', '(config)#'],
      ]
    },
    {
      id: 'global',
      ...
      cmds: [
        ...
        ['service password-enc', isTR ? 'Şifreleri şifrele' : 'Encrypt passwords', '(config)#'],
        ['enable secret <pass>', isTR ? 'Enable secret' : 'Set enable secret', '(config)#'],
        ['enable password <pass>', isTR ? 'Enable password' : 'Set enable password', '(config)#'],
        ...
        ['vtp domain <name>', isTR ? 'VTP domain' : 'Set VTP domain', '(config)#'],
        ['vtp password <pass>', isTR ? 'VTP şifresi' : 'Set VTP password', '(config)#'],
    ...
    },
    {
      ...
      cmds: [
        ...
        ['station-role root', isTR ? 'AP modu ayarla' : 'Set AP mode', '(config-if)#'],
