...
export function getWifiControlPanelStyles(): string {
  return `
    ...
    * { box-sizing: border-box; margin: 0; padding: 0; }
    ...
    .slider:before { position: absolute; content: ""; height: 18px; width: 18px; left: 3px; bottom: 3px; background-color: ${colors.common.white}; transition: .3s; border-radius: 50%; }
