...
export default function Error({
  ...
  const t = {
    tr: {
      title: '500 - Beklenmeyen Hata',
      subtitle: 'Üzgünüz, uygulamada beklenmeyen bir hata meydana geldi.',
      retry: 'Tekrar Dene',
    ...
    en: {
      ...
      subtitle: 'Sorry, an unexpected error occurred in the application.',
      retry: 'Try Again',
