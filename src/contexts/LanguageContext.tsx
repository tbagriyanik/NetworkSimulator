...
const translations: Record<Language, Translations> = {
  tr: {
    ...
    simulatorTitle: 'Network Simulator v1.9.6',
    sizeLabel: 'Boyut',
    ...
    tutorialReadyDesc: 'Artık ağ simülasyonuna başlamaya hazırsınız! İlk 3 rehberli dersi (Cihaz Ekleme, PC CMD Komutları, CLI Temelleri) tamamlayarak temel becerileri kazanmanızı öneririz. Örnek projeleri inceleyin veya kendi topolojinizi oluşturun. Yardım paneli (sağ alt köşe) ve komut referansı her zaman yanınızda. İyi çalışmalar!',
  ...
  en: {
    ...
    tutorialReadyDesc: 'You\'re now ready to start network simulation! We recommend completing the first 3 guided lessons (Adding Devices, PC CMD Commands, CLI Basics) to build foundational skills. Explore example projects or create your own topology. Help panel (bottom-right) and command reference are always available. Good luck!',
